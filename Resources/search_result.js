...
xhr.open("GET", url);
xhr.onload = function() {
  var actInd, arrow, av, avatar, beginReloading, bgcolor, c, created_at, date_label, endReloading, lastUpdatedLabel, post_view, pulling, reloading, row, statusHeader, statusLabel, tableView, tweet, tweet_text, tweets, user_label, _ref;
  try {
